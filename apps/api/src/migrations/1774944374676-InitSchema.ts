...
export class InitSchema1774944374676 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "gaze_weights" ADD CONSTRAINT "FK_ec27f80db029f690a947a68a3e5" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "gaze_weights" DROP CONSTRAINT "FK_ec27f80db029f690a947a68a3e5"`);
